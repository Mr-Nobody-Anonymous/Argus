"""
Webcam testing script for SentinelSight backend.
...
class WebcamTester:
    """Test SentinelSight features using PC webcam"""
    ...
    def run(self, show_window: bool = True, save_output: bool = False):
        ...
        while True:
            ...
            if show_window:
                cv2.imshow('SentinelSight Webcam Tester', display)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='SentinelSight Webcam Tester')
